        ...
        <table class="table table-light table-bordered">
            <thead>
                <tr>
                    ...
                    <th>Precio</th>
                    <th>Cantidad</th>
                    <th  v-if="getUserLogged.isAdmin">Acciones</th>
                </tr>
            </thead>
            <tbody>
                <tr v-for="(producto, index) in getShoppingCartList" :key="index">
                    ...
                    <td  v-if="getUserLogged.isAdmin">
                        <div @click="eliminarItemCarrito" class="d-flex justify-content-center contenedor-icono">
...
export default {
    ...
    computed:{
        ...mapGetters(['getShoppingCartList', 'getUserLogged'])
    },
    methods:{
        ...mapActions(['fetchShoppingCartList']),
        eliminarItemCarrito(){
